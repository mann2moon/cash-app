...
const AuthBackground = () => {
  ...
  return (
    <Box sx={{ position: 'absolute', zIndex: -1, bottom: 0, width: '100%', height: '100%' }}>
      ...
      {/* <img alt="authBackground" src={authBackground} style={{ width: '100%', height: '100%', background: theme.palette.primary.light }} /> */}
    </Box>
  );
};
